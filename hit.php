                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu text-center nav-font" style="background: rgba(0,0,0,0.7)" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-toggle-split text-white" href="legs.php">Legs - Abs</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu text-center nav-font" style="background: rgba(0,0,0,0.7) !important;" aria-labelledby="navbarDropdown">
